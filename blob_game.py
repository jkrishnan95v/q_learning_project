...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 23 15:19:08 2021
...
FOOD_N = 2
ENEMY_N = 3
#These are ids from the dict, not the number

d = {1: (0, 255, 255),  #ssgod
     2: (255, 175, 0),  #water of elixir
     3: (0, 0, 255)}    #bloody mary
...
for episode in range(HM_EPISODES):
    ...
    for i in range(steps):
        ...
        #### Make sure to increase chioces to 8, and move food and enemy
